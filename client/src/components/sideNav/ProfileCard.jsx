...
<div className="max-w-sm w-full mx-auto rounded-xl overflow-hidden bg-white dark:bg-gray-900 dark:text-gray-100">
  <div className="flex justify-center">
    <img src={user.profilePicture} alt="" className="w-18 h-18 lg:w-28 lg:h-28 lg:mx-auto mt-2 md:rounded-full lg: bg-gray-300" />
  </div>
  <div className={`hidden ${isSearchOpen ? "" :"lg:block"} mt-4 text-center`}>
